...
const AGENT_INIT: AgentInitInfo = {
	...
	safetyDefaults: [
		...
		'Use --proof on commit JSON to get proofBundle.safeToUse, proofBundle.whatChanged, proofBundle.whySafe, postWrite.dataConnections, postWrite.formulaState, postWrite.security, and postWrite.visuals.',
