...
export async function inspectCommand(args: string[], flags: Map<string, string>): Promise<number> {
	...
	if (sheetArg) {
		...
		if (flags.has('json')) {
			...
			console.log(bullet('x14 conditional formats', formatCount(sheet.x14ConditionalFormatCount)))
			console.log(bullet('x14 data validations', formatCount(sheet.x14DataValidationCount)))
	...
	console.log(bullet('x14 conditional formats', formatCount(info.x14ConditionalFormatCount)))
	console.log(bullet('x14 data validations', formatCount(info.x14DataValidationCount)))
