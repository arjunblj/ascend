...
From the repository root, the same workflows are available as:

```bash
bun run example:safe-edit ./path/to/file.xlsx ./path/to/file.agent.xlsx
bun run example:safe-edit:http ./path/to/file.xlsx ./path/to/file.api-agent.xlsx
