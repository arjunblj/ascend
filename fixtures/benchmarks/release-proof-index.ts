...
function safeOpenQssEvidence(): readonly ReleaseProofQssAcceptedEvidenceItem[] {
	return [
		...
		},
		{
			...
			acceptedScope:
				'Commit 824e57c5 proves generated workbookView extra attributes such as minimized, showSheetTabs, and windowWidth are cloned, read, written, and reopened without being collapsed to the core workbook-view fields. Commit 64f63423 extends the same preservation shape to workbookPr extra attributes such as checkCompatibility and autoCompressPictures. Commit 95f74c40 preserves extra workbookProtection attributes such as futureProtectionMode, commit 2abf9a4e preserves extra calcPr attributes such as refMode and fullPrecision, and commit 3e79423d preserves workbook fileVersion fields and extra attributes such as productRelease.',
			boundary:
				'Generated workbook metadata preservation evidence only; it does not prove public-workbook generality, full workbook-view parity, workbook protection/security behavior, Excel UI layout equivalence, or arbitrary workbookPr/workbookView/workbookProtection/calcPr/fileVersion semantic interpretation.',
		},
		{
