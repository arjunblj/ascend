...
function todayCommitClaimMatrix(): readonly ReleaseProofTodayCommitClaimMatrixRow[] {
	return [
		...
		},
		{
			...
			releaseOrSotaClaimBecameMoreTrue:
				'Ascend formula/calc behavior is more credible for dynamic-array-style workflows because common IS predicates, ERROR.TYPE, SWITCH, IFS, text scalar/extraction/search/replacement/comparison/value-conversion/formatting/slicing functions, common date/time scalar functions, and common math/rounding/conversion/logarithmic/trigonometric/combinatorics scalar functions now map over range or array operands and spill through focused conditional contexts instead of collapsing to a top-left scalar.',
			evidenceProvesIt: [
