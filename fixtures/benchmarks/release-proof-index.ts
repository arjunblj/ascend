...
function packageActionQssEvidence(): readonly ReleaseProofQssAcceptedEvidenceItem[] {
	return [
		...
		},
		{
			...
			acceptedScope:
				'Commits 1410d809, 8e351092, 75698a98, 346da8b1, 844336cb, 2700c72a, 33169e31, 9f22a961, 6370a2f2, 8e5b8422, 5a027510, c942f981, 9b66af81, 4c463d5e, 3d0d1754, and 4a8acca1 classify package relationships and parts for active content/control/embedding/custom UI, Power Query/Data Model/model-table, chart style/color, document properties/thumbnails, custom XML/custom XML props/XML maps, diagram data, revision metadata, VBA/signature, calc-chain, sheet metadata, slicer/timeline, comments, and threaded-comments surfaces with owner scopes and preservation policies.',
			boundary:
				'Package relationship classification evidence only; it does not execute active content, refresh Power Query, understand Data Model semantics, edit custom UI or custom XML, edit chart styles/colors, refresh slicers/timelines, author comments, prove document-property or calc metadata freshness, verify signatures, or guarantee arbitrary unknown-part recovery.',
		},
		{
