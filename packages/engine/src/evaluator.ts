...
const ARRAY_CONTEXT_MAPPABLE_FUNCTIONS = new Set([
	'ABS',
	'ACOS',
	'ACOSH',
	'ACOT',
...
const ARRAY_MAPPED_RANGE_PRESERVING_ARGS = new Map<string, ReadonlySet<number>>([
	...
	['FORECAST.ETS', new Set([1, 2])],
	['FORECAST.ETS.CONFINT', new Set([1, 2])],
	['FORECAST.ETS.SEASONALITY', new Set([0, 1])],
	['FORECAST.ETS.STAT', new Set([0, 1])],
	['FORECAST.LINEAR', new Set([1, 2])],
	['LARGE', new Set([0])],
	['NETWORKDAYS', new Set([2])],
	['NETWORKDAYS.INTL', new Set([3])],
	['PERCENTILE', new Set([0])],
	['PERCENTILE.EXC', new Set([0])],
	['PERCENTILE.INC', new Set([0])],
