...
<x:metadata xmlns:x="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
  ...
  <x:futureMetadata name="XLDAPR" count="1">
    <x:bk><x:extLst><x:ext uri="{bdbb8cdc-fa1e-496e-a857-3c3f30c029c3}"><xda:dynamicArrayProperties fDynamic="1" fCollapsed="0"/></x:ext></x:extLst></x:bk>
  </x:futureMetadata>
  <x:cellMetadata count="1">
    <x:bk><x:rc t="1" v="0"/></x:bk>
  </x:cellMetadata>
</x:metadata>`,
			'xl/worksheets/sheet1.xml': `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
