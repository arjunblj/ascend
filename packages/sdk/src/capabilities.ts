...
export const EXCEL_CAPABILITIES: readonly ExcelCapability[] = [
	...
	cap(
		...
		'inspectable',
		'P0',
		'Add safe source range edit op, then axes, anchors, and styling inventory.',
		'Chart type, title, and series source refs are inspectable; chart edit is still staged.',
		['packages/io-xlsx/src/reader/reader.test.ts', 'packages/sdk/src/visual-inventory.test.ts'],
	),
	cap(
		'visuals.chartsheets',
		'visuals',
