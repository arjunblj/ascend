...
export const EXCEL_CAPABILITIES: readonly ExcelCapability[] = [
	...
	cap(
		...
		'inspectable',
		'P0',
		'Add safe shape/text replacement operations while preserving unsupported styling exactly.',
	...
	cap(
		...
		'inspectable',
		'P1',
		'Add safe text replacement with plan-time loss audit for unsupported rich text styling.',
