...
const REQUIRED_COMMANDS = [
	...
	'bun test fixtures/xlsx/libreoffice-fixtures.test.ts -t "tracks cached formula parity across LibreOffice formula fixtures"',
	...
	'bun test apps/cli/src/cli.test.ts -t "custom UI callbacks"',
	...
	'bun test packages/sdk/src/agent-workflow.test.ts -t "agent plans open encrypted workbooks"',
	...
	'bun test apps/api/src/server.test.ts -t "encrypted workbook passwords"',
	'bun test apps/mcp/src/index.test.ts -t "encrypted workbook passwords"',
	'bun test apps/cli/src/cli.test.ts -t "plan --password previews encrypted"',
