...
3. Correctness follow-up: property-style journal laws now have a deterministic tracked harness with pre-seeded metadata and package-state replacements plus explicit style/table-style lossy boundaries, but they may rank up only after shrinkable generation or a release-facing exact/lossy proof report.
