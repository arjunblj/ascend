...
3. Correctness follow-up: property-style journal laws now have a deterministic tracked harness with pre-seeded row/column/page/protection/tab metadata replacements, but they may rank up only after shrinkable generation covers those families plus package-state/style operations without collapsing lossy cases into exact cases.
